...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      check_eligibility: async (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`check_eligibility: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const income_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.callContext.currentQueryContext != undefined)) {
          __compactRuntime.typeError('check_eligibility',
                                     'argument 1 (as invoked from Typescript)',
                                     'burs_eligibility.compact line 9 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(income_0),
  ...
  async initialState(...args_0) {
    ...
    if (!(typeof(initial_threshold_0) === 'bigint' && initial_threshold_0 >= 0n && initial_threshold_0 <= 18446744073709551615n)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 1 (argument 2 as invoked from Typescript)',
                                 'burs_eligibility.compact line 5 char 1',
                                 'Uint<0..18446744073709551616>',
                                 initial_threshold_0)
    }
  ...
  async _check_eligibility_0(context, partialProofData, income_0) {
    return income_0
           <
...
export const expectedVk = {
  'check_eligibility': '133bd46cf64f139ffa8c3dd3aeaf580b4aa9ba0153017c9a8037be745382a0a8',
};
