...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      check_eligibility: async (...args_1) => {
        if (args_1.length !== 1) {
        ...
        const result_0 = await this._check_eligibility_0(context,
                                                         partialProofData);
    ...
    this.impureCircuits = {
      check_eligibility: this.circuits.check_eligibility
    };
  ...
  async initialState(...args_0) {
    ...
    const initial_threshold_0 = args_0[1];
    ...
    state_0.setOperation('check_eligibility', new __compactRuntime.ContractOperation());
  ...
  async _check_eligibility_0(context, partialProofData) {
    let t_0;
...
export const expectedVk = {
  'check_eligibility': 'c85998ff22463667504d9b84687e8a3d3cedddbbf5eb65208079b17c297e2118',
};
